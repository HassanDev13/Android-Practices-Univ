package com.practice.algerianpositivevibes.services;
...
public class MonService extends Service {
    ...
    public void onDestroy() {
        ...
        Toast.makeText(getApplicationContext(),"OnDestroy:  Service Chrono Arrêté  avec la valeur  " + count , Toast.LENGTH_LONG).show();
