...
public class BDDHelper extends SQLiteOpenHelper {
    ...
    // Lorsque la table est mise à jour, il faut supprimer l'ancienne table puis recréer une nouvelle
// Ceci évitera d'avoir différentes tables ayant le même nom.
    @Override
